...
- You need columns, indentation or collapsing: [Task list and hierarchy](task-list).
- You need to lock down what can be dragged, or veto a change: [Editing tasks](editing).
- You want successors to move when a predecessor does: [Scheduling](scheduling).
