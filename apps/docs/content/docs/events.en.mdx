---
title: "Events and cancellable changes"
description: "Callbacks, and vetoing an edit before it commits"
---
...
The exact type declarations are in [Changes](ref/changes).
...
[Editing tasks](editing). The full key map is in
...
asking a server first does not work. Their payloads are covered in [Dependencies](dependencies)
and [Reordering rows](reordering).
