...
Everything the drag did not reject. Links across groups or lanes, links onto a summary row, and links whose two dates flatly contradict each other all arrive at the callback.
