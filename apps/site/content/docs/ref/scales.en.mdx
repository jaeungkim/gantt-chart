...
zone name. The readout formats both ends of the dragged range and joins them with an en dash,
unless the two ends format identically, in which case it prints the one label. The shorter
