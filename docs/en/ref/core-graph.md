...
[Scheduling core](core-scheduling.md). The `Task` shape these functions read is on
[Task](task.md). Behaviour lives in [Dependencies](../dependencies.md) and
[Scheduling](../scheduling.md); running the core without the chart is
...
[Critical path core](core-critical-path.md).
